...
import { Plus, School, UserPlus, Trash2, AlertTriangle } from 'lucide-react';
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
export function ClassManagement() {
  const { classes, students, addClass, addStudent, deleteClass, deleteStudent } = useData();
                          ...
                          <AlertDialog>
                            <AlertDialogTrigger asChild>
                              <Button 
                                variant="ghost" 
                                size="icon" 
                                className="h-6 w-6 text-slate-300 opacity-0 group-hover/item:opacity-100 hover:text-red-500 hover:bg-red-50 transition-all"
                              >
                                <Trash2 className="w-3 h-3" />
                              </Button>
                            </AlertDialogTrigger>
